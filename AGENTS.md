# Music for Secondary Schools Student’s Book Form Two — ADT Bundle Reference
...
**Music for Secondary Schools Student’s Book Form Two** — This is an English-language secondary school music textbook from Tanzania, published by the Tanzania Institute of Education for Form Two students, roughly equivalent to lower secondary or early high school level. It covers both practical and theoretical music topics, including rhythm, staff notation, scales, harmony, musical terms, instruments, sound, ensemble performance, piano basics, songwriting, and introductory music production. The book uses a competency-based, activity-rich approach with exercises, listening tasks, composition work, and performance practice, while also drawing on Tanzanian musical examples and cultural context alongside broader Western music theory.
...
├── MUSIC-FORM-2.db                    # SQLite database (pipeline state)
├── MUSIC-FORM-2.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im003": "Certificate of Approval from the United Republic of Tanzania, Ministry of Education, Science and Technology, approving Music for Secondary Schools Student’s Book Form Two as a textbook for Form Two students under the 2023 syllabus, dated 31 May 2025 and signed by Commissioner for Education Dr Lyabwene M. Mtahabwa.",
  "gl001": "A minor scale",
  "gl001_def": "a minor scale that starts on A. It can be played as natural minor or harmonic minor."
}
```
...
```json
{
  "A minor scale": {
    "word": "A minor scale",
    "definition": "a minor scale that starts on A. It can be played as natural minor or harmonic minor.",
    "variations": ["A minor scale","A minor scales"],
    "emoji": "🎹🎶"
  }
}
```
...
```json
{
  "title": "Music for Secondary Schools Student’s Book Form Two",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en"
...
| Original PDF | `MUSIC-FORM-2.pdf` |
| Pipeline database | `MUSIC-FORM-2.db` (SQLite) |
